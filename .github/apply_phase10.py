...
TARGETS = [
    ...
    "accessibility.html",
    "route-recovery.html",
    "content-completeness.html",
    "platform-roadmap.html",
    "help-centre.html",
    "privacy.html",
    "sources.html",
    "about.html",
]
BODY_CLASS = "osb-phase10"
GLOBAL_CSS = "assets/css/global-experience-2026.css?v=20260726-4"
GLOBAL_JS = "assets/js/global-experience-2026.js?v=20260726-4"
PHASE_CSS = "assets/css/phase10-trust-quality-2026.css?v=20260727-1"
...
if not changed:
    raise SystemExit("Phase 10 made no changes")
...
print(f"Phase 10 changed {len(changed)} files")
for item in changed:
